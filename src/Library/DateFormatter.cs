...
public class DateFormatter
{
    ...
    {   
        if(date.Length>=10 & !date.ToString().Contains(" ") ){
            if(date.Substring(0,2).Length!=2 | date.Substring(3,2).Length!=2 | date.Substring(6).Length!=4){
            return "";
            }
        ...
        if(date.ToString().Contains(" ") | date.Length<10){
            return "";
        }
